...
import GooglePlayImage from "../../assets/google-play-img.png";
import NextToImage from "../../assets/appbtntext.png";
import AppleAppImage from "../../assets/appstorebtn.png";
                  ...
                  <div className="col-lg-3 col-md-6 footer-align-left">
                    ...
                    <div className="text-content">
                      <p className="mb-3 mt-4">
                        FashionOrb is an enchanting and easy to use e-Commerce
                        App that allows you to sell your products in a dynamic
                        way.
                      </p>
                      <p className="mb-4">
                        The theme is packed with everything you need to create a
                        new website.
                      </p>
                    </div>
                      ...
                      <div className="footer-address">
                        <ul>
                          ...
                          <li className="pgs-contact-email">
                            ...
                            <span>support@FashionOrb.com</span>
                          </li>
                          <li>
                        ...
                        <Row>
                          <div className="col-12">
                            <div className="footer-content">
                              FashionOrb Mobile app is Available now. Download
                              it now on your favorite device and indulge in a
              ...
              <Container>
                <div className="row align-items-center">
                  <Col md={6} className="float-left">
                    <p>
                      {" "}
                      © Copyright 2019 <Link to="#">FashionOrb</Link> All Rights
                      Reserved.
                    </p>
                  </Col>
