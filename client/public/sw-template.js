...
workbox.routing.registerRoute(/^\/$|home|auth|shop|contact|checkout|cart/, new workbox.strategies.NetworkFirst());
...
// work-images-cache
// workbox.routing.registerRoute(/http:\/\/localhost\/joanne-lee.appspot.com\/.*/,
